...
use App\Models\{WarrantyMaster, Application, ProductTypeClassMaster, CurrencyPricelist};
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // Fetch dropdown options
                    if ($this->categoryId) {
                    $categoryOptions = $this->getDropdownOptions(Application::where('application_id', $this->categoryId)->limit(10)->pluck('application_name') ->toArray(), 'No category available');
                } else {
