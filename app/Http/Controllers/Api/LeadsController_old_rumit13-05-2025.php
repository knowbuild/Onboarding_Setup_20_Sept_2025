...
if ($order_by != '')
{
    $searchRecord = "$application_search $search_by_keyword $date_range_search $estimated_value_search  $last_updated_on_search $hot_enquiry_search_search $ref_source_search $enq_status_search $cust_segment_search $offer_created_search $acc_manager_search $lead_id_search $enq_id_search";
}
else
{
	$order_by="id";
	$order="desc";
    $searchRecord = "$application_search $search_by_keyword $date_range_search $estimated_value_search $last_updated_on_search $hot_enquiry_search_search $ref_source_search $enq_status_search  $offer_created_search $cust_segment_search $acc_manager_search $lead_id_search $enq_id_search";
}
...
$sql_tbl_lead_product						= "SELECT lead_id, sum(pro_price* pro_quantity) as estimated_value FROM tbl_lead_product where lead_id='$inserted_lead_id' ";
...
{
 $msg = array("msg"=>"false","comp_id"=>"This copmany already exists.");
}
else
{
