...
if (!empty($row->alert_date_1) && $row->alert_date_1 !== '0000-00-00') {
    try {
        $alertDate = Carbon::parse($row->alert_date_1);
        $row->days_since_stock_breach = $alertDate->diffInDays(Carbon::now());
    } catch (\Exception $e) {
