...
use App\Models\{User, Customer, Category, Application, ApplicationService, CustomerTradePrice, Product, ProductMain, ProductsEntry, ProQtyMaxDiscountPercentage, Service, ServicesEntry, Currency, WarrantyMaster, ProductTypeClassMaster};
 ...
 public function product_export()
    {
        try {
            ...
            Excel::store(new ProductExport, $filePath, 'public');
 ...
 // Generate public URL for download
    ...
    public function service_export()
    {
        try {
            ...
            // Store the file in public storage
            Excel::store(new ServiceExport, $filePath, 'public');
...
foreach ($worksheet->getRowIterator(1, 1) as $row) {
 ...
 if ($fileHeaders !== $expectedHeaders) {
     ...
     $upcCode = upcCodeService(); // Call the helper function
                ...
                $priceTypeId = Currency::where('code', 'like', $row[9])->value('id') ?? 0;
                ...
                if ($request->type == 'product') {
                    ...
                    $datan = [
                     ...
                     //   'retail_value' => 120.00,
                       ...
                       // 'pro_code_offer' => 'DEMO1',
                      //  'meta_content' => 'Demo meta content',
                      //  'meta_desc' => 'Demo meta description',
                      //  'profile_id' => 1, 
                     //   'Blog_id' => '123',
                        
                     //   'pro_short_desc' => 'Short description',
                    //    'applications' => 'Demo applications',
                     //   'specification' => 'Demo specifications',
                    //    'transducer_selection' => 'Demo transducer selection',
                    //    'features' => 'Demo features',
                     //   'software' => 'Demo software',
                      //   'show_ware_house_stock' => 'Yes',
                     //   'reorder_qty' => 2,
                     //   'sort_order' => 1,
                     //   'pro_short_description' => 'Demo short description',
                         //   'pro_calibration' => 1,
                     //   'qty_slab' => 'No',
                     //   'cat_flag_new' => 0,
                     //   'product_type_id' => 1,
                ...
                if ($request->type == 'service') {
                    $datan = [
                       ...
                       'service_details' => $row[13] ?? null,
                        ...
                        'status' => 'active',
                        'deleteflag' => 'active',
                        'hot_service' => filter_var($row[3] ?? 0, FILTER_VALIDATE_INT),
                       'upc_code' =>  $upcCode,
                    ...
                    //    'retail_value' => 0,
                     //   'seo_title' => 'Demo SEO Title',
                     //   'service_code_offer' => 'DEMO1',
                      
                     //   'service_short_desc' => 'Short description',
                     //   'service_short_description' => 'Demo short description',
                       //   'show_ware_house_stock' => 'Yes',
                     //   'service_period' => 0,
                    //    'barcode' => 0,
                    //    'In_coming_stock' => 0,
             ...
             //   return response()->json(['error' => 'Invalid file format or corrupted file.78'], 500);
                    if (!Service::where([
                     ...
                     //   return response()->json(['error' => $data1], 500);
