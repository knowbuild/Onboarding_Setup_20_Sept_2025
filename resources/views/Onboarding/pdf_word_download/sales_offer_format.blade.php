...
<head>
    ...
    <meta name="description" content="Sale Offer Template PDF">
    <meta name="keywords" content="sale offer, pdf, template">
  <style>
    /* Print settings */
    @page {
      size: auto;
    ...
    table tr th {
      ...
      font-weight: normal;
      vertical-align: top;
      padding: 9px;font-weight: 700;color: #1B1B1B; 
    }

    table tbody tr td {color: #1B1B1B; font-size: 12px;}
    table tr td {
      font-family: Arial, Helvetica, sans-serif;
      font-size: 12px;
      font-weight: normal;
...
<body>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
              <td style="width: 50%;">
                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                  <tr>
                    <td><img src="{{ asset('uploads/Template/company_logo/' . $saleOfferTemplate->company_logo) }}"></td>
                  </tr>
                  <tr>
                    <td>
                      <p style="margin: 0; padding: 0;line-height: 20px;"><b>{{ $saleOfferTemplate->organisation }}</b></p>

                      <p style="margin: 0; padding: 0;line-height: 20px;">{{ $saleOfferTemplate->address }}</p> //convert in 3 line address
              ...
              <td style="width: 50%; text-align: right; vertical-align: middle;"><img src="{{ asset('uploads/Template/certification_img/' . $saleOfferTemplate->certification_img) }}"></td>
            </tr>
          </table>
 ...
 <table cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <tr>
     ...
     <tr>
      <td style="width: 40%; color: #767676;line-height: 20px; padding: 7px 10px 7px 16px;text-transform: uppercase;">E-mail</td>
      <td style="width: 60%;color: #1B1B1B;line-height: 20px; padding: 7px 10px 7px 16px;">24P3394</td>
    </tr>
  </table>
      ...
      <!-- 4 -->
      <tr>
        <td style="padding: 0 0 15px; margin: 0;"><h6 style="padding: 0; margin: 0;font-weight: 600;font-size: 14px;line-height: 20px;">Dear Sir/Madam,</h6>
          <p style="padding: 0; margin: 0; line-height: 20px;">This Refers to the discussions in regard to the above subject. We are pleased to provide our price offer as below for your consideration.</p></td>
      </tr>
...
<tr>
  ...
  <td style="text-align: right;padding: 8px;font-weight: 600;white-space: nowrap;" colspan="2">₹ 14,89,750.00</td>
      ...
      <!-- 5 -->
         ...
         <!-- 6 -->
      <tr>
        <td style="color: #484848;"><p>We are an <strong>ISO 9001:2015</strong> certified quality organization with sales and servicing from 10 locations- <strong>New Delhi, Lucknow, Mumbai, Kolkata, Bangalore, Hyderabad, Bhubaneshwar, Guwahati, Patna, Vadodara & our works at Faridabad to ensure that our customers receive our best attention on supply, training and service.</strong></p></td>
      </tr>
...
Web: www.stanlay.com
      ...
      <tr>
        <td>
<div style="padding: 8px 16px; background: #E6F7F3; border-radius: 8px; margin: 20px 0; text-align: center;color: #03A580;font-weight: 600;line-height: 20px;">
  
<P style="color: #03A580; padding: 0 0 10px; margin: 0;">Thank you for considering purchase from our company. While your point of contact is our sales team member as mentioned above, Other contacts for Coordination who can be of further service pre and post sales are as follows.</P>

<P style="padding: 0; margin: 0;">(Central contact phone : 011-41860000 ; helpline : 011-41406926)</P>

</div>

<div style="width: 100%;">

  <ul style="display: flex; list-style: none; margin: 0 0 24px; padding: 0; color: #484848;">
    <li style="border: 1px solid #E8E8E8; margin: 0 15px 0 0; width: 25%; padding: 10px;">
    <h6 style="padding: 0 0 5px; margin: 0 0 ;font-weight: 700; font-size: 12px;">Sales</h6>
    <p style="padding: 0; margin: 0; line-height: 16px;font-size: 11px;">Ms Mala Bajpai <br />sales@stanlay.com</p>


    </li>
    <li style="border: 1px solid #E8E8E8; margin: 0 15px 0 0;width: 25%; padding: 10px;">
      <h6 style="padding: 0 0 5px; margin: 0 0 ;font-weight: 700; font-size: 12px;">Shipping & Coordination</h6>
      <p style="padding: 0 0 10px; margin: 0 0 10px;font-weight: 400; line-height: 16px; border-bottom: 1px solid #E8E8E8;font-size: 11px;">Mr. Abhay Verma, <br /> Executive , Logistics / Shipping <br /> <a href="mailto:cord@stanlay.com" style="color:#484848">cord@stanlay.com</a></p>

      <p style="padding: 0; margin: 0;font-weight: 400; line-height: 16px;font-size: 11px;">Team Leader: Mr Pawan Kumar <br /> <a href="mailto:cord@stanlay.com" style="color:#484848">pawan@stanlay.com</a></p>

    </li>
    <li style="border: 1px solid #E8E8E8; margin: 0 15px 0 0;width: 25%;padding: 10px;">
      <h6 style="padding: 0 0 5px; margin: 0 0 ;font-weight: 700; font-size: 12px;">Invoicing & Accounts</h6>
      <p style="padding: 0 0 10px; margin: 0 0 10px;font-weight: 400; line-height: 16px; border-bottom: 1px solid #E8E8E8;font-size: 11px;">Mr Sanjeev <br />  <a href="mailto:accounts@stanlay.com" style="color:#484848">accounts@stanlay.com</a></p>

      <p style="padding: 0; margin: 0;font-weight: 400; line-height: 16px;font-size: 11px;">Team Leader: Mr Pankaj Jain <br /> <a href="mailto:finance@stanlay.com" style="color:#484848">finance@stanlay.com</a> </p>


    </li>
    <li style="border: 1px solid #E8E8E8; margin: 0 0 0 0;width: 25%;padding: 10px;">

<h6 style="padding: 0 0 5px; margin: 0 0 ;font-weight: 700; font-size: 12px;">Technical queries & Service</h6>
      <p style="padding: 0 0 10px; margin: 0 0 10px;font-weight: 400; line-height: 16px; border-bottom: 1px solid #E8E8E8;font-size: 11px;">Mr Amit Sharma   <br /> <a href="mailto:finance@stanlay.com" style="color:#484848">amit@stanlay.com</a></p>

      <p style="padding: 0; margin: 0;font-weight: 400; line-height: 16px;font-size: 11px;">Team Leader: Mr Muneeb Rah
man  <br /> <a href="mailto:finance@stanlay.com" style="color:#484848">muneeb@stanlay.com</a> </p>
...
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">iii. Seller will endeavor to meet the delivery schedule as specified in the Order, but in no case Seller will be responsible for delay in deliver at the time specified in the Order especially in the 
occurrence of unforeseeable events, circumstances or conditions beyond the Seller's control, such as all events of Force Majeure, which prevent to deliver in time; such events shall include 
in particular Embargoes, Export Restrictions, Armed Conflicts, Transport and Customs Delay, Shipping Damage, Power and Raw Material Shortage, Labour Disputes and Default of a major 
Supplier. The concerned delivery dates shall be extended for a period equal to the duration of such events.</p>
...
<p style="margin: 0; padding: 0 0 5px; font-size: 11px; color: #484848;line-height: 15px;">V. Should an event of Force Majeure lead to the cancellation of a purchase order already accepted by ACL, then ACL maximum aggregate liability shall be the repayment, without interests, 
of the sums received for the Products or Services not supplied.</p>

<strong style="font-weight: 700;font-size: 12px; padding: 0 0 5px; display: block;">3.  ACCEPTANCE OF PRODUCTS</strong>

<p style="font-size: 11px;line-height: 15px; padding: 0 0 10px; margin: 0;">Seller will supply the Products in accordance with manufacturer’s quality control processes and procedures. Buyer’s inspection of the Products shall be made at the Buyer’s facility and at Buyer’s expense.  Buyer shall, immediately upon receipt, notify Seller of any damage, discrepancy, or nonconformity, other than quantity, in the Products.  Buyer’s failure to inspect or failure to timely notify Seller of any damage, discrepancy, or nonconformity shall be deemed a waiver of any and all such claims and shall relieve Seller from its obligations and any liability. Seller’s weights and quantity counts taken at the shipping point shall govern.  Buyer hereby waives any claims unless Buyer notifies Seller in writing of any such discrepancy within ten (10) calendar days after the date of receipt of products. </p>

<strong style="font-weight: 700;font-size: 12px; padding: 0 0 5px; display: block;">4.   PAYMENT</strong>

<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">Unless otherwise agreed to,</p>
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">1. Standard Payments are 100% in Advance from date of Proforma invoice date, but, in any case, before shipment occurs, unless any other payment term has been agreed to.</p>
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">2. Payments shall be made, without deductions and without any set-off.</p>
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">3. Delay of the payment caused by Buyer, may entitle Seller to :</p>
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">4. Delay the fulfillment of its obligations until such payment has been effected;</p>
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">5. Extend the time of delivery accordingly;</p>
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">6. Charge interest @12% per annum basis or 3 times the RBI interest rates, at months rests, whichever is higher.</p>

<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">7. We are an MSME unit and covered by provisions of Section 15 of the MSME Act of Govt of India which states that the payment to the MSME suppliers shall be made within the date specified in the agreement (order) not exceeding 45 days from date of delivery/acceptance beyond which the Act specifies charges at the rate of 3 times the RBI interest rate at monthly rests.</p>

<p style="margin: 0; padding: 0 0 10px; font-size: 11px; color: #484848;line-height: 15px;">8. Retain the title of goods delivered until due amounts have been fully received.</p>

<strong style="font-weight: 700;font-size: 12px; padding: 0 0 5px; display: block;">5. WARRANTY</strong>

<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">1. Seller warrants that its Products shall be free from defects in material and workmanship, for a period of 12 months or as per manufacturers policy for product supplied from the dispatch date. Seller’s obligation is limited to repairing or replacing parts or products which are returned, without alteration or further damage, and which at ACL or manufacturer’s judgment, were defective or became defective during its normal use.</p>
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">2. For Products returned during the warranty period, shipping costs from Buyer to Seller are borne by Buyer, from Seller to Buyer are borne by Seller.</p>
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">3. Any different warranty, granted by the Buyer to its retailers, contractors and clients, even as final consumers, does not engage ACL in anyway.</p>
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">4. The above mentioned warranty excludes any other remedies and it has to be considered the only and exclusive remedy foreseen for the Buyer and its retailers , contractors and clients, with reference to Products purchased, being, expressively understood that any kind of limitation and/or discharge of responsibility provided by the present warranty is referred to both (I) the responsibility as against any third parties, pursuant to the legislation regarding the manufacturer responsibility and (II) the warranty provided by the law in force.</p>
<p style="margin: 0; padding: 0 0 10px; font-size: 11px; color: #484848;line-height: 15px;">5.The foregoing warranties are in lieu of all other warranties and Seller makes no other warranties whether written, oral, express, implied or statutory, including, but not limited to, warranties of merchantability or fitness for particular purpose.</p>

<strong style="font-weight: 700;font-size: 12px; padding: 0 0 5px; display: block;">6.  DISCLAIMER, LIMITED LIABILITY</strong>
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">1. Buyer, before proceeding to the purchase of the Products is recommended to duly examine the Seller documentation relevant to the technical characteristics of the Products, in order to evaluate if the Products are fitted for the expected use.</p>
...
<p style="margin: 0; padding: 0 0 10px; font-size: 12px; color: #484848;line-height: 15px;">In no event shall Seller be liable for special, indirect, incidental, exemplary, punitive or consequential damages including, but not limited to, loss of profits or revenue, caused by the purchase and use of the Products. Buyer assumes all risks and liability resulting from use of the Products purchased, whether used separately or in combination with other products.</p>

<strong style="font-weight: 700;font-size: 12px; padding: 0 0 5px; display: block;">7.  GOVERNING LAW, DISPUTE</strong>
<p style="margin: 0; padding: 0; font-size: 11px; color: #484848;line-height: 15px;">Buyer hereby irrevocably agrees that disputes arising under this Agreement unless resolved mutually, shall be subject to jurisdiction of courts in New Delhi, India.</p>
